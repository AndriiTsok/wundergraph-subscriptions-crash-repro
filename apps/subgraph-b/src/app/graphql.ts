...
export type Subscription = {
  ...
  nodeUpdated?: Maybe<Product>;
};


export type SubscriptionNodeUpdatedArgs = {
  id: Scalars['ID']['input'];
};
...
export type SubscriptionResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = ResolversObject<{
  nodeUpdated?: SubscriptionResolver<Maybe<ResolversTypes['Product']>, "nodeUpdated", ParentType, ContextType, RequireFields<SubscriptionNodeUpdatedArgs, 'id'>>;
}>;
